...
bool SensorProcessorBase::readParameters(std::string& inputSourceName)
{
    ...
    nodeHandle_->get_parameter(inputSourceName + ".sensor_processor.voxelgrid_filter_size",
                                              ...
                                              PointCloudType::Ptr pointCloudTransformed, const std::string& targetFrame)
{
    ...
    try
    {
        ...
        // RCLCPP_DEBUG_THROTTLE(nodeHandle_->get_logger(), clock, 5, "Point cloud transformed to frame %s for time
        // stamp %f.", targetFrame.c_str(),
...
bool SensorProcessorBase::filterPointCloudSensorType(const PointCloudType::Ptr /*pointCloud*/) { return true; }
