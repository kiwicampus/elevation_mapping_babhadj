...
bool StructuredLightSensorProcessor::readParameters(std::string& inputSourceName)
{
    ...
    nodeHandle_->get_parameter(inputSourceName + ".sensor_processor.normal_factor_a",
                               sensorParameters_["normal_factor_a"]);
    nodeHandle_->get_parameter(inputSourceName + ".sensor_processor.normal_factor_b",
                               sensorParameters_["normal_factor_b"]);
    nodeHandle_->get_parameter(inputSourceName + ".sensor_processor.normal_factor_c",
                               sensorParameters_["normal_factor_c"]);
    nodeHandle_->get_parameter(inputSourceName + ".sensor_processor.normal_factor_d",
                               sensorParameters_["normal_factor_d"]);
    nodeHandle_->get_parameter(inputSourceName + ".sensor_processor.normal_factor_e",
                               sensorParameters_["normal_factor_e"]);
    nodeHandle_->get_parameter(inputSourceName + ".sensor_processor.lateral_factor",
                               sensorParameters_["lateral_factor"]);
    nodeHandle_->get_parameter(inputSourceName + ".sensor_processor.cutoff_min_depth",
                               sensorParameters_["cutoff_min_depth"]);
    nodeHandle_->get_parameter(inputSourceName + ".sensor_processor.cutoff_max_depth",
